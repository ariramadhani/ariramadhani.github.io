    ...
    <div class="container">
        ...
        <div>
            ...
            <div class="portfolio__content" data-content id="app">
                <div class="row">
                    <div class="col-sm-3 col-6 portfolio__col">
                        <a href="assets/img/app/food.png" class="app-popup" >
                            <img src="assets/img/app/food.png"alt="your image" id="produk_ulasan_image" class="portfolio__img">
                        </a>          
                    </div> 
                    <div class="col-sm-3 col-6 portfolio__col">
                        <a href="assets/img/app/finance.png" class="app-popup" >
                            <img src="assets/img/app/finance.png"alt="your image" id="produk_ulasan_image" class="portfolio__img">
                        </a>          
                    </div> 
                    <div class="col-sm-3 col-6 portfolio__col">
